...
//	output reg [7:0]CODEWORD,
   ...
   output reg num
    ...
    // TODO: initailize starting screen
...
//		LED<=scan_code[8:1];			//You can put the code on the LEDs if you want to, that’s up to you 
		...
		else if (CODEWORD == ONE) begin			//or if the ARROW_DOWN was pressed, then
			LED <= LED - 1;					//count down LED register 
            num <= 1'b0;
            end
            
            
            //TODO: call seconf screen herre
